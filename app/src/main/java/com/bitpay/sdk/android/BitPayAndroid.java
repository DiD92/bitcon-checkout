...
public class BitPayAndroid extends BitPay implements Parcelable {
    ...
    public BitPayAndroid(ECKey ecKey, String clientName, String envUrl, Context c) throws BitPayException {
        super(ecKey, clientName, envUrl, c);
    }

    public BitPayAndroid(String clientName, String envUrl, Context c) throws BitPayException {
        super(clientName, envUrl, c);
    }

    public BitPayAndroid(Token token, String envUrl, Context c) throws BitPayException {
        super(token, envUrl, c);
    }
    public BitPayAndroid(String clientName, Context c) throws BitPayException {
        super(clientName, c);
    }
    public BitPayAndroid(Context c) throws BitPayException {
        super(c);
    }
    ...
    public static final Parcelable.Creator<BitPayAndroid> CREATOR = new Parcelable.Creator<BitPayAndroid>() {
        public BitPayAndroid createFromParcel(Parcel in) {
            ...
            BitPayAndroid result = null;
            try {
                result = new BitPayAndroid(client, env, _context);
            } catch (BitPayException e) {
                e.printStackTrace();
            }
            ...
            if (eckey != null) {
                try {
                    result._ecKey = KeyUtils.loadEcKey(_context);
                } catch (IOException e) {
    ...
    public static class GetClientTask extends AsyncTask<String, Void, BitPayAndroid> {
        ...
        protected final BitPayAndroid doInBackground(String... params) {
            ...
            try {
                ...
                BitPayAndroid client = new BitPayAndroid(KeyUtils.createEcKeyFromHexString(ecKey), "Android Client", "https://test.bitpay.com/", _context);
    ...
    public static class GetClientWithTokenTask extends AsyncTask<String, Void, BitPayAndroid> {
        ...
        protected final BitPayAndroid doInBackground(String... params) {
            ...
            BitPayAndroid client = null;
            try {
                client = new BitPayAndroid(token, url == null ? "https://test.bitpay.com/" : url, _context);
            } catch (BitPayException e) {
                e.printStackTrace();
            }
            return client;
