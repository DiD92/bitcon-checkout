...
public class Invoice implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(buyerFields, 0);
    ...
    public static final Parcelable.Creator<Invoice> CREATOR = new Parcelable.Creator<Invoice>() {
        public Invoice createFromParcel(Parcel in) {
            ...
            invoice.setBuyer((BuyerInfo) in.readParcelable(getClass().getClassLoader()));
    ...
    @JsonProperty("buyerFields")
    public void setBuyerInfo(BuyerInfo buyerFields) {
    ...
    public Hashtable<String, String> getFlags() {
        return flags;
    }

    public void setFlags(Hashtable<String,String> flags) {
        this.flags = flags;
    }
